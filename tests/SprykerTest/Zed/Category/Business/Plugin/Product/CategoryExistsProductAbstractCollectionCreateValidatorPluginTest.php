 ...
 * @group Plugin
 * @group Product
 * @group CategoryExistsProductAbstractCollectionCreateValidatorPluginTest
 *
 * Add your own group annotations below this line
 */
class CategoryExistsProductAbstractCollectionCreateValidatorPluginTest extends Unit
{
    ...
    public function testValidateReturnsErrorWhenCategoryUuidDoesNotExist(): void
    {
        ...
        // Act
        $productAbstractCollectionResponseTransfer = (new CategoryExistsProductAbstractCollectionCreateValidatorPlugin())->validate(
    ...
    public function testValidatePassesWhenNoCategoryUuidsProvided(): void
    {
        // Arrange
        $productAbstractCollectionRequestTransfer = (new ProductAbstractCollectionRequestTransfer())
            ->addProductAbstract((new ProductAbstractTransfer())->setSku(static::PRODUCT_ABSTRACT_SKU));
