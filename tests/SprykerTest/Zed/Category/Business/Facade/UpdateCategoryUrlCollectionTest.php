 ...
 * @group Business
 * @group Facade
 * @group UpdateCategoryUrlCollectionTest
 * Add your own group annotations below this line
 */
class UpdateCategoryUrlCollectionTest extends Unit
{
    ...
    public function testUpdatesCategoryUrl(): void
    {
        // Arrange
        $categoryTransfer = $this->tester->haveLocalizedCategory();
        $categoryLocalizedAttributesTransfer = $categoryTransfer->getLocalizedAttributes()->getIterator()->current();
        $initialCategoryUrlEntity = $this->tester->findUrlCategoryEntityByNodeAndLocale(
            $categoryTransfer->getCategoryNodeOrFail(),
            $categoryLocalizedAttributesTransfer->getLocaleOrFail(),
        );

        $categoryLocalizedAttributesTransfer->setName(static::TEST_CATEGORY_NAME);
        $this->tester->updateCategoryLocalizedAttribute($categoryLocalizedAttributesTransfer, $categoryTransfer->getIdCategory());
        ...
        // Act
        $categoryUrlCollectionResponseTransfer = $this->tester->getFacade()->updateCategoryUrlCollection(
        ...
        $categoryUrlEntity = $this->tester->findUrlCategoryEntityByNodeAndLocale(
            $categoryTransfer->getCategoryNodeOrFail(),
            $categoryLocalizedAttributesTransfer->getLocaleOrFail(),
        );
        $this->assertNotNull($categoryUrlEntity);
        $this->assertNotSame($initialCategoryUrlEntity->getUrl(), $categoryUrlEntity->getUrl());
    ...
    public function testThrowsExceptionWhenRequiredTransferPropertyIsMissing(CategoryUrlCollectionRequestTransfer $categoryUrlCollectionRequestTransfer): void
    {
        ...
        // Act
        $this->tester->getFacade()->updateCategoryUrlCollection($categoryUrlCollectionRequestTransfer);
    }
