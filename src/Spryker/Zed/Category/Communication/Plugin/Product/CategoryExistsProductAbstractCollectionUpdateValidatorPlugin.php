...
use Spryker\Zed\ProductExtension\Dependency\Plugin\ProductAbstractCollectionUpdateValidatorPluginInterface;

/**
 * @method \Spryker\Zed\Category\Business\CategoryBusinessFactory getBusinessFactory()
 */
class CategoryExistsProductAbstractCollectionUpdateValidatorPlugin extends AbstractPlugin implements ProductAbstractCollectionUpdateValidatorPluginInterface
{
    /**
     * {@inheritDoc}
